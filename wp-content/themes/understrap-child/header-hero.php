<?php
/**
 * Alternate header includes hero before nav
 *
...
<div class="hfeed site" id="page">
    ...
    <div class="hero" style="background-image: url('<?php echo $featuredImage;?>'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
        <div class="container">
            <h1 class="hero__header"><img class="hero__logo" src="#" alt="Born to Be Brave" /></h1>
            <p class="hero__lead"><?php echo types_render_field( "tagline", array( ) ); ?></p>
            <hr class="my-4">
            <p class="hero__lead">
                <a class="hero__button" href="<?php echo get_site_url();?>/video/" role="button">Watch Full Video</a>
            </p>
        </div>
