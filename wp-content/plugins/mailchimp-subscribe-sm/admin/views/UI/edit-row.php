...
<div class="lpp_modal_row edit_row" style="background: #fff;">
  ...
  <div class="edit_options_left_row">
                        ...
                        <div id="pluginops_input_tabs" class="popbinputTabsWrapper POPBInputNormalRow">
                          ...
                          <div class="popb_input_tabContent">
                            <div class="content_popb_tab_1 popb_tab_content">
                              ...
                              <br> <br>
                              <label>Image :</label>
                              <input id="image_location1" type="text" class=" rowBgImg upload_image_button2992 row_edit_fields"  name='lpp_add_img_1' value='' placeholder='Insert Image URL here' data-optname="rowData.bg_img" > <br> <br>
                              <label></label>
      ...
      <h3 class="nonPremUserNotice"> Tip You can edit your row at one place and changes will appear everywhere : <a href="https://pluginops.com/page-builder/?ref=OptinGlobalRow" target="_blank"> Learn More </a></h3>
    </div>
  </div>
</div>
