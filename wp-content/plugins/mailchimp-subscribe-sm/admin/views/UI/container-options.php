                  ...
                  <?php
                      ...
                      if($proWidgetLoaded == false) {
                          ...
                          <div style="display: inline-block; width: 49%; float: left;">
                              <div class="widget POPB_widget wdt-draggable" data-type="wigt-pb-text"><i class="fa fa-text-width"></i> <br> Text</div>
                              ...
                              <div class="widget prem-widget" data-type="wigt-pb-iconList"> <i class="fa fa-list"></i> <br> Icon List <p>Pro Only</p></div>
                              <div class="widget prem-widget" data-type="wigt-pb-icons"><i class="fa fa-fonticons"></i> <br> Icons <p>Pro Only</p></div>
                              <div class="widget prem-widget" data-type="wigt-pb-icons"><i class="fa fa-fonticons"></i> <br> Shortcode <p>Pro Only</p></div>
                          </div>
                          <div style="display: inline-block; width: 49%;">
                              <div class="widget POPB_widget wdt-draggable" data-type="wigt-WYSIWYG"><i class="fa fa-file-text-o"></i> <br> HTML Editor</div>
                              <div class="widget POPB_widget wdt-draggable" data-type="wigt-btn-gen"><i class="fa fa-mouse-pointer"></i> <br> Call To Action </div>
                              ...
                              <div class="widget prem-widget" data-type="wigt-pb-embededVideo"> <i class="fa fa-youtube-play"></i> <br> Embed Video  <p>Pro Only</p></div>
                              <div class="widget prem-widget" data-type="wigt-pb-countdown"><i class="fa fa-sort-numeric-desc"></i> <br> Countdown <p>Pro Only</p></div>
                              <div class="widget prem-widget" data-type="wigt-pb-progressBar"><i class="fa fa-align-left"></i> <br> Progress Bar  <p>Pro Only</p></div>
                          </div>
