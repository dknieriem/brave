            ...
            $.each(widgetPbFbFormFeilds,function(index, val){
                ...
                jQuery('.formFieldItemsContainer').append('<li class="fieldNo-'+index+'">'+
                    ...
                    '<div  class="accordContentHolder" style="background: #fff;"> '+
                        '<label>Type : </label> <select class="fbFieldType"> <option value="text">Text</option> <option value="tel">Tel</option> <option value="email">Email</option> <option value="number">Number</option> <option value="url">URL</option> <option value="date">Date</option> <option value="time">Time</option> <option value="textarea">Textarea</option> <option value="select">Select</option> <option value="radio">Radio</option> <option value="checkbox">Checkbox</option> <option value="hidden">Hidden</option> </select> <br> <br> <hr> <br> '+
                        '<div class="thisFieldOptions"> '+
                            '<label> Label :</label> <input type="text" class="fbFieldLabel" value="'+val["thisFieldOptions"]["fbFieldLabel"]+'"> <br> <br> <hr> <br> '+
                            ' <label> Placeholder :</label> <input type="text" class="fbFieldPlaceHolder" value="'+val["thisFieldOptions"]["fbFieldPlaceHolder"]+'"> <br> <br> <hr> <br> '+
                            ' <label> Required :</label> <select class="fbFieldRequired"> <option value="false">No</option> <option value="true">Yes</option> </select> <br> <br> <hr> <br> '+
                            ' <label> Field Width :</label> <select class="fbFieldWidth"> <option value="100">Default</option> <option value="20">20%</option> <option value="25">25%</option> <option value="33">33%</option> <option value="40">40%</option> <option value="50">50%</option> <option value="60">60%</option> <option value="66">66%</option> <option value="75">75%</option> <option value="80">80%</option> <option value="100">100%</option> </select> <br> <br> <hr> <br> '+
                            ' <label> Preset Value :</label>  <input type="text" class="fbFieldPreset" value="'+val["thisFieldOptions"]["fbFieldPreset"]+'">   <br> <br> <hr> <br>  '+
                        '</div> <br> <br> '+
                        '<div class="textareaOptions pb_hidden"> '+
                            '<label>Textarea Rows: </label> <input type="number" class="fbtextareaRows" value="'+val["thisFieldOptions"]["fbtextareaRows"]+'"> <br> <hr> <br> <br> '+
                        ' </div> '+
                        '<div class="multiOptionField pb_hidden"> '+
                            '<label>Options: </label> <textarea class="multiOptionFieldValues" rows="5" value="'+val["thisFieldOptions"]["multiOptionFieldValues"]+'">'+val["thisFieldOptions"]["multiOptionFieldValues"]+'</textarea> <br> <span> Enter each option in separate line.</span> <br> <hr> <br> <br> '+
                            '<label>Display Inline :</label> <select class="displayFieldsInline"> <option value="inline-block">Yes</option> <option value="block">No</option> </select> <br> <hr> <br> <br> '+
                        '</div> '+
                    '</div> '+
                '</li>');
                ...
                this.model.set({
                    widgetFormBuilder:{
                      ...
                      widgetPbFbFormMailChimp: {
                        ...
                        fbgreCaptcha:$('.fbgreCaptcha').val(),
                        fbgreCSiteKey:$('.fbgreCSiteKey').val(),
                        fbgreCSiteSecret:$('.fbgreCSiteSecret').val(),
                        wfbMHEnable: $('.wfbMHEnable').val(), // Market Hero Enable
                        wfbMHApiKey:$('.wfbMHApiKey').val(), // Market Hero Api Key
                      },
        ...
        if (passedWidgetData['widgetType'] == 'wigt-pb-liveText' && thisWidgetType == 'wigt-pb-liveText') {
            ...
            this.model.set({
                widgetText:{
                  ...
                  widgetTextAlignment: thisWidgetDefault['widgetTextAlignment'],
