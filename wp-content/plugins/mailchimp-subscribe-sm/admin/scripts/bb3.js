    ...
    if (action == 'fontTag') {
      ...
      if (oldStyles == '' ) {
        if ( $(el).parents('.pb-text-widget').length ) {
          parentElColor = $(el).parents('.pb-text-widget').css('color'); 
          parentElFontSize = $(el).parents('.pb-text-widget').css('font-size'); 
          parentElLineHeight = $(el).parents('.pb-text-widget').css('line-height'); 
