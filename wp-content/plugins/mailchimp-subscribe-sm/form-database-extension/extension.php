...
$checkifupdateManagerisActive = true;
if ( $checkifupdateManagerisActive == true ) {

add_action( 'admin_enqueue_scripts', 'smfb_premExt_formDatabase_extension_script' );

}

function smfb_premExt_formDatabase_extension_script( ) {

    $screen_id = get_current_screen();
    
    if ($screen_id->post_type === 'pluginops_forms'){
        wp_enqueue_script( 'smfb_premExt_formDatabase_extension_script_enqueue', plugins_url( '',plugin_basename( __FILE__ ) ).'/table.js', array( 'jquery' ), false, true );
    }
...
function smfb_premExt_formBuilder_database_renderFormDataTable($postID){
    $checkifupdateManagerisActive = true;
    if ( $checkifupdateManagerisActive == true ) {
        ob_start();
                  ...
                  <div>
                    ...
                    <?php foreach ( $smfb_form_Fields as $smfb_field_name => $smfb_formBuilder_single_field) {
                      ...
                      <th> View </th>
                        ...
                        <br>
                        <br>
                        <div class="btn-green large-btn downloadFormDatabtn" style="float:left;"  data-formID='<?php echo "allFormDataObject_$formNameKeyWithoutSpaces"; ?>' data-formName='<?php echo "$formNameKey"; ?>' >Download Data</div>
                  </div>
                </div>
