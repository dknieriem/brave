...
<p class="description"><?php printf( __( 'This code will be used to generate the shortcode output. %sLearn more about code editor%s.', 'shortcodes-ultimate-maker' ), '<a href="https://getshortcodes.com/docs/creating-custom-shortcodes-with-the-shortcode-creator-add-on/" target="_blank"><nobr>', '</nobr></a>' ); ?></p>
