                    ...
                    <form id="mec_styling_form">
                        ...
                        <div class="mec-form-row">
                            ...
                            <div class="mec-col-8">
                                ...
                                <a class="mec-tooltip" title="<?php esc_attr_e('To be GDPR compliant you may need to disable Google fonts!', 'mec'); ?>"><i title="" class="dashicons-before dashicons-editor-help"></i></a>
                            </div>
